...
static char *afl_environment_variables[] = {
    ...
    "AFL_ADARARE_A6_SHARING_MODE", "AFL_ADARARE_A6_OFFPOLICY_MODE",
    "AFL_ADARARE_ALPHA",
    "AFL_ADARARE_BUILD_ID", "AFL_ADARARE_CMP_A3_BOOST",
    "AFL_ADARARE_CMP_BASELINE_EMA", "AFL_ADARARE_CMP_BASELINE_NORM",
    "AFL_ADARARE_CMP_MIN_GAIN", "AFL_ADARARE_CMP_ONE_SHOT_SITE",
    "AFL_ADARARE_CMP_PRODUCER_MODE", "AFL_ADARARE_CMP_RARITY_LAMBDA",
    "AFL_ADARARE_CMP_REWARD", "AFL_ADARARE_CMP_WIN_CLIP",
    "AFL_ADARARE_CONTEXT_MODE", "AFL_ADARARE_CONTEXTUAL",
    "AFL_ADARARE_MODE", "AFL_ADARARE_RARITY_CONTEXT",
    "AFL_ADARARE_RARITY_REWARD", "AFL_ADARARE_RARITY_GATE",
    "AFL_ADARARE_TELEMETRY", "AFL_ADARARE_AUDIT",
    "AFL_ADARARE_DICT_BASELINE_PROB",
    "AFL_ADARARE_DICT_ENABLE", "AFL_ADARARE_DISCOUNT",
    "AFL_ADARARE_ENABLE_A6",
    "AFL_ADARARE_GATE_CAP", "AFL_ADARARE_GATE_MULT",
    "AFL_ADARARE_MIX_P", "AFL_ADARARE_POLICY",
    "AFL_ADARARE_RARITY_EMA",
    "AFL_ADARARE_REVISIT_MS", "AFL_ADARARE_REWARD_ALPHA",
    "AFL_ADARARE_REWARD_BETA", "AFL_ADARARE_REWARD_C1",
    "AFL_ADARARE_REWARD_C2", "AFL_ADARARE_REWARD_C3",
    "AFL_ADARARE_REWARD_DELTA", "AFL_ADARARE_REWARD_GAMMA",
    "AFL_ADARARE_RIDGE", "AFL_ADARARE_SCORE_DECAY",
    "AFL_ADARARE_STATIC_ARM",
    "AFL_ADARARE_VERIFY", "AFL_ADARARE_WARMUP_PULLS",
    "AFL_ALIGNED_ALLOC", "AFL_ALLOW_TMP", "AFL_ANALYZE_HEX", "AFL_AS",
    "AFL_AUTORESUME", "AFL_AS_FORCE_INSTRUMENT", "AFL_BANDIT",
    "AFL_BANDIT_DEBUG", "AFL_BANDIT_DEBUG_PATH",
    "AFL_BANDIT_WINDOW_MS", "AFL_BANDIT_REWARD", "AFL_BANDIT_REWARD_FORMULA",
    "AFL_BANDIT_BETA", "AFL_BANDIT_GAMMA", "AFL_BANDIT_TEMPORAL",
    "AFL_BANDIT_LAMBDA", "AFL_BANDIT_GATE", "AFL_BANDIT_RHO",
    "AFL_BANDIT_ALPHA", "AFL_BANDIT_GATE_MIN", "AFL_BANDIT_DICT",
    "AFL_BANDIT_DICT_PROB_DEFAULT", "AFL_BANDIT_DISCOUNT",
    "AFL_BANDIT_WARMUP_WINDOWS", "AFL_BANDIT_RARITY_NORM",
    "AFL_BENCH_JUST_ONE",
